...
for size in ${Size[@]}; do
    ...
    scene_ls=(
        ...
        # 3461811179177118163
        # 4058410353286511411
        5200186706748209867 #8
        # 6104545334635651714
        # 16345319168590318167
    )
    fi
    data_root=Data/$dataset
    save_root=Save_$size/$dataset
    for scene in ${scene_ls[@]}; do
        for interframe_solver_choice in ${interframe_solver_choice_ls[@]}; do
            ...
            python main.py --data_folder $data_folder --log_path $save_root/$scene/$save_dir --model $model --conf_threshold $conf_threshold --interframe_solver_choice $interframe_solver_choice  --submap_size $size
